...
type OauthClient struct {
	...
	UserID      string         `sql:"type:char(36)"`
}
...
type OauthUser struct {
	MyGormModel
	RoleID   sql.NullString `sql:"type:varchar(20);index;not null" gorm:"column:role_id"`
	Role     *OauthRole
	Username string         `sql:"type:varchar(254);unique;not null"`
	Password sql.NullString `sql:"type:varchar(512)" gorm:"column:_password"`
}

...
type ServiceInterface interface {
	...
	FindClientByUserID(userID string) (*models.OauthClient, error)
	CreateClient(clientID, secret, redirectURI string, userID string) (*models.OauthClient, error)
	CreateClientTx(tx *gorm.DB, clientID, secret, redirectURI string, userID string) (*models.OauthClient, error)
	...
	FindUserByID(userID string) (*models.OauthUser, error)
	...
	AuthUserByID(userID string) (*models.OauthUser, error)

...
func (_m *ServiceInterface) GetConfig() *core.Config {
	ret := _m.Called()

	var r0 *core.Config
	if rf, ok := ret.Get(0).(func() *core.Config); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*core.Config)
		}
	}
...
func (_m *ServiceInterface) CreateClient(clientID string, secret string, redirectURI string, userID string) (*models.OauthClient, error) {
	ret := _m.Called(clientID, secret, redirectURI, userID)

	var r0 *models.OauthClient
	if rf, ok := ret.Get(0).(func(string, string, string, string) *models.OauthClient); ok {
		r0 = rf(clientID, secret, redirectURI, userID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.OauthClient)
		}
...
func (_m *ServiceInterface) CreateClientTx(tx *gorm.DB, clientID string, secret string, redirectURI string, userID string) (*models.OauthClient, error) {
	ret := _m.Called(tx, clientID, secret, redirectURI, userID)

	var r0 *models.OauthClient
	if rf, ok := ret.Get(0).(func(*gorm.DB, string, string, string, string) *models.OauthClient); ok {
		r0 = rf(tx, clientID, secret, redirectURI, userID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.OauthClient)
		}
